...
public class EssentialCategoryClassifier implements CategoryClassifier {
    CategoryClassifier nextClassifier = null;
    List<Item> items = null;

    @Override
    public void setNext(CategoryClassifier nextClassifier) { this.nextClassifier = nextClassifier; }
    ...
    public String classifyItemCategory(String[] orderItem) {
        ...
        for(Item item : items){
            if(item.getName().equals(itemName)) return "Essential";
        }
